...
public class JwtUtil {
    ...
    public String reissueToken(String email, Long kakaoId) {
        return Jwts.builder()
                .id(UUID.randomUUID().toString())
                .subject(email)
                .claim("role", roleFor(kakaoId))
    ...
    public String roleFor(Long kakaoId) {
        return adminIds.contains(String.valueOf(kakaoId)) ? "ADMIN" : "USER";
    }
